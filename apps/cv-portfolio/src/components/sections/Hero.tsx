...
export default function Hero() {
  ...
  return (
    <section
      className="
        relative 
        bg-gradient-to-br from-amber-100 via-lime-50 to-emerald-100
        dark:bg-gradient-to-br dark:from-blue-900 dark:via-gray-900 dark:to-green-900
    ...
    >
      ...
      <div
        ...
        className="
          ...
          animate-gradient-xy
          bg-gradient-to-tr from-amber-300 via-lime-100 to-emerald-200
          dark:bg-gradient-to-tr dark:from-blue-800 dark:via-gray-800 dark:to-emerald-900
          backdrop-blur-xl
